...
const BorderGlow = ({
  ...
  const handlePointerMove = useCallback((e) => {
    ...
    // Calculate proximity: closer = higher value (0-100)
    // Max distance is diagonal of card + window size for smooth effect
  ...
  // Global mouse tracking to detect proximity from anywhere
  useEffect(() => {
